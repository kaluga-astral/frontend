...
const getCrossIcon = (color: string) => {
  const preparedColor = prepareColorToUrl(color);
      ...
      return {
        ...
        '& .MuiButtonBase-root.MuiSwitch-switchBase.Mui-disabled': {
          '& + .MuiSwitch-track': {
            ...
            '&::before': {
              backgroundImage: getCheckIcon(theme.palette.grey[500]),
            },
            '&::after': {
              backgroundImage: getCrossIcon(theme.palette.grey[500]),
            },
          },
        },
    ...
    track({ theme }) {
      return {
        ...
        '&::before': {
          ...
          backgroundImage: getCheckIcon(theme.palette.background.default),
        },
        '&::after': {
          right: theme.spacing(2),
          backgroundImage: getCrossIcon(theme.palette.background.default),
        },
      };
    },
