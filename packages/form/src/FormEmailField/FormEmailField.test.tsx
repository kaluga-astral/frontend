...
describe('FormEmailField', () => {
    ...
    const TestComponent = () => {
      ...
      return (
        <Form form={form} onSubmit={form.handleSubmit(() => undefined)}>
          <FormEmailField name="user" control={form.control} />
  ...
  it('Prop:ref: is present', () => {
    ...
    const FormEmailFieldWithRef = () => {
      ...
      return (
        <Form form={form}>
          <FormEmailField name="user" control={form.control} ref={ref} />
        </Form>
      );
    };

    renderWithTheme(<FormEmailFieldWithRef />);
  ...
  it('Prop:inputRef: Фокус на поле после клика на Submit', async () => {
    const TestComponent = () => {
      ...
      return (
        <Form form={form} onSubmit={form.handleSubmit(() => undefined)}>
          <FormEmailField name="user" control={form.control} label="user" />
          <button type="submit">submit</button>
        </Form>
      );
    };
