 ...
 * BottomDrawer используется в для реализации адаптива всплывающий элементов. Например, [Dialog](/docs/components-dialog--docs), [Menu]((/docs/components-menu--docs)), [Popover]((/docs/components-popover--docs))....
 *
