...
const { JIRA_URL, STORYBOOK_URL, TELEGRAM_TOKEN, TELEGRAM_NEWS_CHAT_ID: TELEGRAM_CHAT_ID, CHANGELOG_DIR_PATH: EXTERNAL_CHANGELOG_DIR_PATH } = process.env; 
 ...
 */
export const CHANGELOG_DIR_PATH = EXTERNAL_CHANGELOG_DIR_PATH || path.resolve(__dirname, '..', '..', 'changelog');
